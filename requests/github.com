...
<html lang="en">
  ...
  <meta name="request-id" content="EE0E:0F82:3802B2B:5F189D0:5BC97F97" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="EE0E:0F82:3802B2B:5F189D0:5BC97F97" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="YWM1MjA3OGU5MGM3YzlhMmI0ZmRkZWQ3ZmUzODM0OTA5ZjY0ZDljYWZjM2Q5NWI5MmQ2YzBmMjM3ZTIzNWVkYXx7InJlbW90ZV9hZGRyZXNzIjoiMTE4LjI0LjE5LjQ3IiwicmVxdWVzdF9pZCI6IkVFMEU6MEY4MjozODAyQjJCOjVGMTg5RDA6NUJDOTdGOTciLCJ0aW1lc3RhbXAiOjE1Mzk5MzIwNTYsImhvc3QiOiJnaXRodWIuY29tIn0=">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="3ec8d7f6d3209e2ce66ebf222e7c740e7c8a177f">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=D9DP6n+BKy+s26fe+VEJ5cdtFtvPevq8tEz64J6+hZIpttQzcwmCS3L17ooqA1WsFOu0arv2CVHy6+/PAvLoPA=="
          spellcheck="false"
          autocomplete="off"
          >
      ...
      <div class="col-md-7 text-center text-md-left ">
        ...
        <div class="mx-auto col-sm-8 col-md-5 hide-sm">
          <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
            <form class="home-hero-signup js-signup-form" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ekphWZCQEbYIu7UVHKfC0BeZfPg8AZLGDQYXO5fr+5o9ul2JeTfWov57h9oWOirv47V9TpVsN5SXMbW7EjNwLA==" />              <dl class="form-group mt-0">
                <dt class="input-label">
                  <label class="form-label f5" for="user[login]">Username</label>
                </dt>
                <dd>
                  <auto-check src="/signup_check/username" csrf="FunEgnZqZpb1fospEhyUFFaXHOTtUgyxooKblXUYnbA0WULMmNpfJmrkaoCPsXk6pLQ/UVZ1FRT3iflxGyed5Q==">
              ...
              <dl class="form-group">
                ...
                <dd>
                  <auto-check src="/signup_check/email" csrf="UoaS4wkl41JuBIHUJP7A5pBZ5tvrHUSVRyJwGTQvzcsKESbGp1OrK7zEKF+wqZmduGF4mJxTaSlMgahEwdcT/g==">
              ...
              <password-strength
                data-minimum-character-count="7"
                data-beginning-of-sentence="Make sure it&#39;s"
                data-checks="[&quot;more than 15 characters&quot;, &quot;or at least 7 characters&quot;, &quot;including a number&quot;, &quot;a lowercase letter&quot;]"
              >
                <dl class="form-group">
                  <dt class="input-label">
                  ...
                  <p class="form-control-note">Make sure it&#39;s more than 15 characters, or at least 7 characters, including a number, and a lowercase letter.</p>
                </dl>
              </password-strength>
              <input type="hidden" name="source" class="js-signup-source" value="form-home">
              <input type="text" name="required_field_d050" id="required_field_d050" hidden="hidden" class="form-control" />
<input type="hidden" name="timestamp" value="1539932056787" class="form-control" />
<input type="hidden" name="timestamp_secret" value="3c6b0139401c0ab3c94991e8b478ac12f65729bd9c1cb4f77cdd23e95100fa95" class="form-control" />
...
<div class="text-white" style="background-color: #10181e;">
  <div class="d-md-flex flex-items-center">
    <div class="col-md-6 d-md-flex flex-justify-end" style="background: #13191E url(https://assets-cdn.github.com/images/modules/site/patterns/bg-universe.svg) top left/auto repeat;">
      <div class="width-full px-4 px-sm-6 pl-lg-3 py-6 banner-half d-sm-flex flex-items-start">
        <img src="https://assets-cdn.github.com/images/modules/site/events/universe-icon.svg" alt="Universe Logo" width="64" class="mb-1 mr-3 mr-md-4">
        <div>
          <h4 class="h3-mktg mb-2">GitHub Universe</h4>
          <p>Talks from all three conference tracks are streaming now.</p>
          <a href="https://githubuniverse.com/watch" class="Bump-link h4-mktg text-blue-light no-underline" data-ga-click="Home Universe banner, click, text:Watch live">Watch live <span class="Bump-link-symbol">→</span></a>
        </div>
      </div>
    </div>
    <div class="col-md-6" style="background-color: #10181e;">
      <div class="col-sm-10 col-md-12 px-4 px-sm-6 py-6 banner-half">
        <h4 class="h3-mktg mb-2">Launch report</h4>
        <p>
          Everything we released at GitHub Universe
        </p>
        <a href="https://blog.github.com/2018-10-16-future-of-software" class="Bump-link h4-mktg text-blue-light no-underline" data-ga-click="Home Universe blog banner, click, text:Learn more">Learn more <span class="Bump-link-symbol">→</span></a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container-lg p-responsive">
    <div class="col-md-9 col-lg-10 bg-white p-6 mx-auto text-center">
      ...
      <p class="mb-3 text-center">
        <a class="btn-mktg" href="https://enterprise.github.com/contact" data-ga-click="Home Enterprise prompt, click, text:Contact Sales">Contact Sales</a>
        <a class="btn-mktg btn-outline-mktg" href="https://enterprise.github.com/trial" data-ga-click="Home Enterprise prompt, click, text:Start a free trial">Start a free trial</a>
      </p>
    </div>
  </div>
</div>
...
<div class="py-7 py-md-8 py-lg-9">
  <div class="container-lg p-responsive">
    ...
    <a href="/pricing" class="col-md-7 mx-auto Tile Tile--dots clearfix p-4 border pt-5 no-underline Bump-link bg-white" style="min-height: 0">
      ...
      <div class="overflow-hidden">
        ...
        <p>Compare plans <span class="Bump-link-symbol">&rarr;</span></p>
      </div>
    </a>
...
<div class="py-7 py-md-8 py-lg-9">
  ...
  <div class="py-7 py-md-8 py-lg-9 bg-gray-dark">
    ...
    <div class="container-xl p-responsive py-6 mt-lg-6">
      <form class="home-hero-signup js-signup-form" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Ew32yKihPoaSx38l4m7lHOXNowFh0NP6pH1XXuvqhQ5U/coYQQb5kmQHTero8w0jEeGit8i9dqg+SvXebjIOuA==" />        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <auto-check src="/signup_check/username" csrf="Lli3LapbbHqT3TNlFQMujhH+jAq53SFAZrs9pgqhBcoM6DFjROtVygxH0syIrsOg492vvwL6OOUzsF9CZJ4Fnw==">
          ...
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <auto-check src="/signup_check/email" csrf="wa7v705CQSjTHpFrz5Tv5twbvV1wHUx6D4WmZiSF4q+ZOVvK4DQJUQHeOOBbw7ad9CMjHgdTYcYEJn470X08mg==">
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input type="text" name="required_field_2cd3" id="required_field_2cd3" hidden="hidden" class="form-control" />
<input type="hidden" name="timestamp" value="1539932056796" class="form-control" />
<input type="hidden" name="timestamp_secret" value="94a75119aa9c05d61399b4f3ee74a6431d4b39959018e0bf1f73429cca359667" class="form-control" />
